...
import dga_classifier.bilbo_hybrid as bilbo_hybrid
...
def run_experiments(nfolds=10):
    ...
    print '========== bilbo_hybrid =========='
    bilbo_hybrid_results = bilbo_hybrid.run(**options)
    ...
    return {
        'options': options,
        'model_results': {
            'bilbo_hybrid_results': bilbo_hybrid_results
        }
    }
...
def calculate_metrics(model_results):
    ...
    print(" model_fpr, model_tpr, model_auc   ",  model_fpr, model_tpr, model_auc)
